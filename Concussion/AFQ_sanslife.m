...
wholeBrainConnectome = ['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/major_tracts/' sprintf('data_b%s_aligned_trilin_noMEC_ensemble.mat',bvals)];
[fascicles,classification,fg,fg_classified] = feAfqSegment(dtFile, wholeBrainConnectome);
save(['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/life/post_afq_fg_sanslife'], 'fg', 'fg_classified', 'classification', 'fascicles', '-v7.3')
