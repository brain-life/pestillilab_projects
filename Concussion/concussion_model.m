function concussion_model(subj,bvals)
...
load(['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/Concussion_model/results/fe_post_life.mat']);
...
save(['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/Concussion_model/results/fe_post_concussion.mat'], 'fe_prob', '-v7.3')
