...
% This function will combine all of the probabilistic outputs from mrtrix tractography into singular .mat file.  This will be used
...
for ilm = 1:length(lmaxparam)
		fe_path = fullfile(projdir1);
        	fg_tmp = fgRead(fullfile(fe_path,'fibers_new',sprintf('data_b%s_aligned_trilin_noMEC_csd_lmax%s_wm_SD_PROB-500000.tck',bvals,lmaxparam{ilm})));
	...
	fgFileName = fullfile(fe_path, 'major_tracts', sprintf('data_b%s_aligned_trilin_noMEC_probabilistic_ensemble.mat',bvals,lmaxparam{ilm}));
