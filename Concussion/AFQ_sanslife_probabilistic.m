function AFQ_sanslife_probabilistic(subj,bvals)
% This function will run Automated Fiber Quantification (Yeatman et al, 2014; https://github.com/yeatmanlab/AFQ). It will take
% the probabilistic ensemble connectome and segment streamlines into 20 major fiber tracts.
%
...
wholeBrainConnectome = ['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/major_tracts/' sprintf('data_b%s_aligned_trilin_noMEC_probabilistic_ensemble.mat',bvals)];
[fascicles,classification,fg,fg_classified] = feAfqSegment(dtFile, wholeBrainConnectome);
save(['/N/dc2/projects/lifebid/Concussion/concussion_test/' subj '/diffusion_data/' bvals '/life/post_afq_fg_sanslife_probabilistic'], 'fg', 'fg_classified', 'classification', 'fascicles', '-v7.3')
